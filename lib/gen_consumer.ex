defmodule Exdistex.GenConsumer do
    use GenServer
    alias AMQP.Basic
    ...
    def establish_contract(consumer, context_expression), do: GenServer.call(consumer, {:establish_contract, context_expression})

    def handle_call({:establish_contract, context_expression}, _from, %{chan: channel} = state) do
