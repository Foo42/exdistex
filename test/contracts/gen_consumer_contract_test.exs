defmodule Exdistex.GenConsumerContractTest do
  alias Exdistex.GenConsumerContract
  use ExUnit.Case
  ...
  test "handle_call delegates and mixes returned state back in" do
    ...
    {:reply, reply, %{contract_state: final_contract_state}} = GenConsumerContract.handle_call(:some_message, :someone, outer_state)
